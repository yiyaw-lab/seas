...
SYSTEM_PROMPT = (
    ...
    "from approved sources (arXiv, GitHub, Hugging Face, OpenAI, Anthropic, "
    "Google AI, and your feeds). For Anthropic specifically, fetch "
    "https://www.anthropic.com/news (no feed, but the page fetches fine). If the "
    ...
    "You can also read code: github_list(repo, path) explores an approved repo "
    "and github_read_file(repo, path) reads a file from it. Use these to reason "
    "about actual projects, not just trending titles. "
